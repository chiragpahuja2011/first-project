...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.csrf().disable()
		.authorizeRequests()
		.antMatchers("/","/home","/style/**","/bootstrap/**","/js/**","/images/**","/cook-signup","/cook-upload","/cookSignup/loadData","/cookSignup/cook","/help-user","/cook-search","/header","/profile/cook/{\\d}","/view-cook-profile").permitAll()
